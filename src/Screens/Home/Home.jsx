    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div className="container px-5">
                    <img src="./public/512.png" alt="coop logo" width="50px"/>
                    <a className="navbar-brand" ><span className="fw-bolder text-primary"> Cooperativa Salta</span></a>
            ...
            <section>   
                <img src="./public/background.jpg" alt="background mountain" width="100%" />
            </section>
